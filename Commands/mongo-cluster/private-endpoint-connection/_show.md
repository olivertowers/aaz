# [Command] _mongo-cluster private-endpoint-connection show_
...
- Get a private endpoint connection on a Mongo Cluster resource.
    ```bash
        mongo-cluster private-endpoint-connection show --resource-group TestGroup --mongo-cluster-name myMongoCluster --private-endpoint-connection-name pecTest.5d393f64-ef64-46d0-9959-308321c44ac0
    ```
